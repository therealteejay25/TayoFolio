...
const Build = () => {
  return (
    <div className='relative h-full'>
        <h3 className='text-background text-sm font-medium flex items-center justify-end gap-2 py-2'><Logo size={12} color='#fff' /> SHIPPING FEATURES BIT BY BIT.</h3>
        ...
        <div className="absolute z-10 right-16 -top-16">
            <HeroStack src='/git.svg' />
          </div>
        <div className="absolute z-10 left-16 -top-16">
            <HeroStack src='/github.svg' />
          </div>

...
const Design = () => {
  return (
    <div className='relative h-full'>
        <h3 className='text-background text-sm font-medium flex items-center justify-end gap-2 py-2'><Logo size={12} color='#fff' /> TAILORING USER DRIVEN DESIGN FOR EFFECTIVE SOLUTIONS.</h3>
